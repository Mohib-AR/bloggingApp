  ...
  return (
    <div className="p-3 md:mx-auto ">
        ...
        <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          <div className="flex justify-between">
            <div className="">
              ...
              <p className="text-sx ">{totalUsers}</p>
            </div>
          ...
          <div className="flex gap-2 text-sm">
            <span className="text-green-500 flex items-center">
              <HiArrowNarrowUp />
              {lastMonthUsers}
              <div className="text-gray-500 pl-2">Last month</div>
            </span>
          </div>
        </div>
        <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          <div className="flex justify-between">
            <div className="">
              ...
              <p className="text-sx ">{totalPosts}</p>
            </div>
        ...
        <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          <div className="flex justify-between">
            <div className="">
              ...
              <p className="text-sx ">{totalComments}</p>
            </div>
      ...
      <div className="flex flex-wrap gap-4 py-3 mx-auto justify-center">
        ...
        <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800">
          <div className="flex justify-between p-3 text-sm font-semibold mb-2">
